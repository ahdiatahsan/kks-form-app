...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('attachment_ones', function (Blueprint $table) {
            ...
            $table->string('p44_1', 5)->nullable();
            $table->string('p44_2', 5)->nullable();
            $table->string('p45_1', 5)->nullable();
            $table->string('p45_2', 5)->nullable();
            $table->string('p46_1', 5)->nullable();
            $table->string('p46_2', 5)->nullable();
            $table->string('p47_1', 5)->nullable();
            $table->string('p47_2', 5)->nullable();
            $table->string('p48_1', 5)->nullable();
            $table->string('p48_2', 5)->nullable();
            $table->string('p49_1', 5)->nullable();
            $table->string('p49_2', 5)->nullable();
            $table->string('p50_1', 5)->nullable();
            $table->string('p50_2', 5)->nullable();
            $table->string('p51_1', 5)->nullable();
            $table->string('p51_2', 5)->nullable();
            $table->string('p52_1', 5)->nullable();
            $table->string('p52_2', 5)->nullable();
            $table->string('p53_1', 5)->nullable();
            $table->string('p53_2', 5)->nullable();
            $table->string('p54_1', 5)->nullable();
            $table->string('p54_2', 5)->nullable();
            $table->string('p55_1', 5)->nullable();
            $table->string('p55_2', 5)->nullable();
            $table->string('p56_1', 5)->nullable();
            $table->string('p56_2', 5)->nullable();
            $table->string('p57_1', 5)->nullable();
            $table->string('p57_2', 5)->nullable();
            $table->string('p58_1', 5)->nullable();
            $table->string('p58_2', 5)->nullable();
            $table->string('p59_1', 5)->nullable();
            $table->string('p59_2', 5)->nullable();
            $table->string('p60_1', 5)->nullable();
            $table->string('p60_2', 5)->nullable();
            $table->string('p61_1', 5)->nullable();
            $table->string('p61_2', 5)->nullable();
            $table->string('p62_1', 5)->nullable();
            $table->string('p62_2', 5)->nullable();
            $table->string('p63_1', 5)->nullable();
            $table->string('p63_2', 5)->nullable();
            $table->string('p64_1', 5)->nullable();
            $table->string('p64_2', 5)->nullable();
            $table->string('p65_1', 5)->nullable();
            $table->string('p65_2', 5)->nullable();
            $table->string('p66_1', 5)->nullable();
            $table->string('p66_2', 5)->nullable();
            $table->string('p67_1', 5)->nullable();
            $table->string('p67_2', 5)->nullable();
            $table->string('p68_1', 5)->nullable();
            $table->string('p68_2', 5)->nullable();
