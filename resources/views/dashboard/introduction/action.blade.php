<div class="d-flex justify-content-center">
    @if (Auth::user()->hasAnyRole('administrator'))
        <div class="ms-4 ms-sm-2">
            <a class="btn btn-sm btn-icon btn-light-success btn-active-light-dark" data-bs-toggle="tooltip" title="Ubah"
                href="{{ route('introduction.edit', $introduction->id) }}">
        ...
        <div class="ms-2">
            <a class="btn btn-sm btn-icon btn-light-danger btn-active-light-dark delete" data-bs-toggle="tooltip"
                title="Hapus" id="{{ $introduction->id }}">
                <span class="svg-icon svg-icon-5 m-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none">
                        <path
    ...
    <div class="ms-2">
        <a class="btn btn-sm btn-icon btn-light-primary btn-active-light-dark" data-bs-toggle="tooltip" title="Rincian"
            href="{{ route('introduction.show', $introduction->id) }}">
            <span class="svg-icon svg-icon-5 m-0">
