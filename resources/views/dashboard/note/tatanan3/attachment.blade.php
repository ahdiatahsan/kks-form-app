<div class="d-flex justify-content-center">
    @if ($noteThree->attachment_pdf != null)
        <div class="ms-4 ms-sm-2">
            <a href="{{ asset('storage/attachmentThree/' . $noteThree->attachment_pdf) }}" target="_blank"
    ...
    @endif
    @if ($noteThree->attachment_img != null)
        <div class="ms-2">
            <a href="{{ asset('storage/attachmentThree/' . $noteThree->attachment_img) }}" target="_blank"
