<div class="d-flex justify-content-center">
    @if ($noteOne->attachment_pdf != null)
        <div class="ms-4 ms-sm-2">
            <a href="{{ asset('storage/attachmentOne/' . $noteOne->attachment_pdf) }}" target="_blank"
    ...
    @endif
    @if ($noteOne->attachment_img != null)
        <div class="ms-2">
            <a href="{{ asset('storage/attachmentOne/' . $noteOne->attachment_img) }}" target="_blank"
