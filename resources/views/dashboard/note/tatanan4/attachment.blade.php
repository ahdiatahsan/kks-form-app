<div class="d-flex justify-content-center">
    @if ($noteFour->attachment_pdf != null)
        <div class="ms-4 ms-sm-2">
            <a href="{{ asset('storage/attachmentFour/' . $noteFour->attachment_pdf) }}" target="_blank"
    ...
    @endif
    @if ($noteFour->attachment_img != null)
        <div class="ms-2">
            <a href="{{ asset('storage/attachmentFour/' . $noteFour->attachment_img) }}" target="_blank"
