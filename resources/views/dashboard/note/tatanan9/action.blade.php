@if ($noteNine->answer != null && Auth::user()->hasAnyRole('administrator'))
    <div class="d-flex justify-content-center">
        <div class="ms-2">
            <a href="#" class="btn btn-sm btn-icon btn-light-success btn-active-light-dark" data-bs-toggle="modal"
                data-bs-target="#modal-note-{{ $noteNine->id }}">
    ...
    {{-- Start::Modal Note --}}
    <div class="modal fade" id="modal-note-{{ $noteNine->id }}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h5>Form Catatan Soal No.{{ $noteNine->id }}</h5>
                ...
                <div class="modal-body scroll-y mx-5">
                    <form class="form" action="{{ route('noteNine.update', $noteNine->id) }}" method="POST"
                        autocomplete="off">
                        @csrf
                        @method('PATCH')
