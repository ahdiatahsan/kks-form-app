<div class="d-flex justify-content-center">
    @if ($noteNine->attachment_pdf != null)
        <div class="ms-4 ms-sm-2">
            <a href="{{ asset('storage/attachmentNine/' . $noteNine->attachment_pdf) }}" target="_blank"
    ...
    @endif
    @if ($noteNine->attachment_img != null)
        <div class="ms-2">
            <a href="{{ asset('storage/attachmentNine/' . $noteNine->attachment_img) }}" target="_blank"
