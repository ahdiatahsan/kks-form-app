<div class="d-flex justify-content-center">
    @if ($noteSix->attachment_pdf != null)
        <div class="ms-4 ms-sm-2">
            <a href="{{ asset('storage/attachmentSix/' . $noteSix->attachment_pdf) }}" target="_blank"
    ...
    @endif
    @if ($noteSix->attachment_img != null)
        <div class="ms-2">
            <a href="{{ asset('storage/attachmentSix/' . $noteSix->attachment_img) }}" target="_blank"
