@if ($noteFive->answer != null && Auth::user()->hasAnyRole('administrator'))
    ...
    {{-- Start::Modal Note --}}
    <div class="modal fade" id="modal-note-{{ $noteFive->id }}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h5>Form Catatan Soal No.{{ $noteFive->id }}</h5>
                ...
                <div class="modal-body scroll-y mx-5">
                    <form class="form" action="{{ route('noteFive.update', $noteFive->id) }}" method="POST"
                        autocomplete="off">
                        @csrf
                        @method('PATCH')
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <textarea class="form-control" name="note" id="note" rows="5">{{ $noteFive->note }}</textarea>
                        </div>
