<div class="d-flex justify-content-center">
    @if ($noteFive->attachment_pdf != null)
        <div class="ms-4 ms-sm-2">
            <a href="{{ asset('storage/attachmentFive/' . $noteFive->attachment_pdf) }}" target="_blank"
    ...
    @endif
    @if ($noteFive->attachment_img != null)
        <div class="ms-2">
            <a href="{{ asset('storage/attachmentFive/' . $noteFive->attachment_img) }}" target="_blank"
