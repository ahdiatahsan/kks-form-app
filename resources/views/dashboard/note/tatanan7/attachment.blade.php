<div class="d-flex justify-content-center">
    @if ($noteSeven->attachment_pdf != null)
        <div class="ms-4 ms-sm-2">
            <a href="{{ asset('storage/attachmentSeven/' . $noteSeven->attachment_pdf) }}" target="_blank"
    ...
    @endif
    @if ($noteSeven->attachment_img != null)
        <div class="ms-2">
            <a href="{{ asset('storage/attachmentSeven/' . $noteSeven->attachment_img) }}" target="_blank"
