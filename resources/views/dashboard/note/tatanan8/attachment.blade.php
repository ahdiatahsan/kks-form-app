<div class="d-flex justify-content-center">
    @if ($noteEight->attachment_pdf != null)
        <div class="ms-4 ms-sm-2">
            <a href="{{ asset('storage/attachmentEight/' . $noteEight->attachment_pdf) }}" target="_blank"
    ...
    @endif
    @if ($noteEight->attachment_img != null)
        <div class="ms-2">
            <a href="{{ asset('storage/attachmentEight/' . $noteEight->attachment_img) }}" target="_blank"
