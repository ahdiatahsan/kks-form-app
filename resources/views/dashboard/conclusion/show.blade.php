<x-dashboard.layout>
    ...
    <x-slot name="title">Penutup</x-slot>
    {{-- End::Head component --}}
    ...
    <x-slot name="toolbar">
        <x-dashboard.toolbar.main>
            ...
            <x-slot name="backbutton">
                <!--begin::Button-->
                <a href="{{ route('conclusion.index') }}" class="btn btn-sm btn-light-success fw-bolder">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    ...
                    <span class="text-muted mt-1 fw-bold fs-7">Tahun Periode {{ $conclusion->setting->period }}</span>
                </h3>
                <div class="card-toolbar">
                    @if ($conclusion->attachment != null)
                    <a href="{{ asset('storage/conclusion/' . $conclusion->attachment) }}" class="btn btn-sm btn-light-primary">
