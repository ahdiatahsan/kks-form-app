        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('conclusion.create') }}" class="btn btn-sm btn-light-primary">
        ...
        <script>
            $(document).on('click', '.delete', function() {
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        var url = '{{ route("conclusion.destroy", ":conclusion") }}';
                        url = url.replace(':conclusion', id);
        ...
        <script>
            $(document).ready(function() {
                $('#datatable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('conclusion.datatable') }}",
                    columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    }, {
