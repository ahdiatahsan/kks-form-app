        ...
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder text-dark fs-5 my-1">Pengaturan</span>
                    <span class="text-muted mt-1 fw-bold fs-7">Beranda</span>
                </h3>
                <div class="card-toolbar">
                    @if (Auth::user()->hasAnyRole('administrator|office'))
                    <a href="{{ route('setting.create') }}" class="btn btn-sm btn-light-primary">
        ...
        <script>
            $(document).on('click', '.delete', function() {
                ...
                swal.fire({
                    ...
                    text: "Data yang terhapus termasuk seluruh data yang terikat dengan periode ini dan tidak dapat dikembalikan lagi.",
                    icon: "warning",
                    ...
                    if (result.value) {
                        var url = '{{ route("setting.destroy", ":setting") }}';
                        url = url.replace(':setting', id);
