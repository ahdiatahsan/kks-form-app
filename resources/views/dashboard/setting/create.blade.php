<x-dashboard.layout>
    ...
    <x-slot name="toolbar">
        <x-dashboard.toolbar.main>
            ...
            <x-slot name="backbutton">
                <!--begin::Button-->
                <a href="{{ route('setting.index') }}" class="btn btn-sm btn-light-success fw-bolder">
    ...
    <x-slot name="post">
        <!--begin::form-->
        <form class="form" action="{{ route('setting.store') }}" method="POST" autocomplete="off">
            @csrf
            <!--begin::card-->
            <div class="card">
                <!--begin::Card header-->
                ...
                <div class="card-body">
                    <div class="mb-6">
                        ...
                        <div class="input-group input-group-sm">
                            <input class="form-control" type="text" name="period" value="{{ old('period') }}"
                                required>
                        </div>
                    </div>
                </div>
