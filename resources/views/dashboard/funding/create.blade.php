<x-dashboard.layout>
    ...
    <x-slot name="post">
        <!--begin::form-->
        <form class="form" action="{{ route('funding.store') }}" method="POST" autocomplete="off"
                ...
                <div class="card-body">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="input-group input-group-sm">
                            <input class="form-control flatpickr" type="text" name="date_activity"
                                value="{{ old('date_activity') }}" required>
                        </div>
                    </div>
                    <div class="mb-6">
                    ...
                    <div class="mb-8">
                        <label class="form-label">
                            <span class="fs-7 required">Berkas Pendanaan</span>
                    ...
                    <div class="mb-8">
                        <label class="form-label">
                            <span class="fs-7 required">Dokumentasi</span>
                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                title="Ukuran maksimal dokumentasi (jpg, jpeg, png, webp) adalah 2MB."></i>
                        </label>
                        <div class="input-group input-group-sm">
                            <input class="form-control" type="file" name="attachment_img" required>
                        </div>
                    </div>
                </div>
                <!--end::Card body-->
