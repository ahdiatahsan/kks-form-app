        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="mx-auto mw-1000px w-100 pt-5 pb-5"
                    action="{{ route('tatananSeven.update', $tatananSeven->id) }}" method="POST"
                    ...
                    <div class="w-100">
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    11. Pemanfaatan kembali material dan sumber daya yang digunakan melalui konsep 4R
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    12. Persentase perusahaan menyampaikan laporan Rencana Pengelolaan Lingkungan (RKL)/
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="fluid-container pt-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p21"
                                                value="d,0">
                                            <label class="form-check-label">d. Tidak ada UMKM yang memiliki pelayanan
                                                kesehatan/Pos UKK
                                            </label>
                                        </div>
                                    </div>
