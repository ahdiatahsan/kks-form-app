        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="mx-auto mw-1000px w-100 pt-5 pb-5"
                    action="{{ route('tatananSix.update', $tatananSix->id) }}" method="POST"
                    ...
                    <div class="w-100">
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    3. Adanya regulasi/kebijakan terkait sistem manajemen keselamatan lalu lintas dan
                                    angkutan jalan
                                    <div class="fluid-container pt-4">
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    5. Penyediaan layanan transportasi publik dan kawasan tertib lalu lintas masuk ke
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="fluid-container pt-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p9"
                                                value="c,25">
                                            <label class="form-check-label">c. Ada dari pemerintah/swasta namun tidak
                                                terakreditasi
                                            </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    12. Persentase jam kerja pengemudi : maksimal 12 jam dan 4 jam istirahat angkutan
                                    umum
                                    <div class="fluid-container pt-4">
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    15. Terdapat pos, fasilitas dan petugas pemeriksa kelaikan umum, fasilitas perbaikan
                                    ...
                                    <div class="fluid-container pt-4">
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p18"
                                                value="a,100">
                                            <label class="form-check-label">a. Melakukan pemantauan kualitas udara,
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    ...
                                    standar kesehatan higiene (tempat cuci tangan,tempat mencuci piring,tempat sampah,
                                    dll.)
                                    <div class="fluid-container pt-4">
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p22"
                                                value="d,0">
                                            <label class="form-check-label">d. < 20% belum memenuhi standar </label>
                                        </div>
                                    </div>
                                    <div class="input-group input-group-sm pb-4">
                                    ...
                                    <div class="fluid-container pt-4">
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p23"
                                                value="a,100">
                                            <label class="form-check-label">a. ada, toilet pria,wanita dan penyandang
                                                disabilitas
                                            </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                    ...
                                    <div class="fluid-container pt-4">
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p28"
                                                value="a,100">
                                            <label class="form-check-label">a. tersedia petugas keamanan berseragam,
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="fluid-container pt-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p31"
                                                value="b,50">
                                            <label class="form-check-label">b. ada data/informasi dan tidak dilakukan
                                                updating
                                            </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="fluid-container pt-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p42"
                                                value="b,50">
                                            <label class="form-check-label">b. Ada, aktif namun tidak memiliki Dasar
                                                penetapan/SK
                                            </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
