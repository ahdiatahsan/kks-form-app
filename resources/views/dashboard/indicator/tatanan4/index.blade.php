                    ...
                    <div class="w-100">
                        ...
                        <form action="{{ route('tatananFour.update', $tatananFour->id) }}" method="POST"
                            ...
                            <div class="fv-row">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        2. Keberadaan program UKS/M dalam perencanaan daerah (RPJMD, RKPD, Renstra PD
                                        dan
                                        Renja PD)
                                        <div class="fluid-container pt-4 pb-2">
                                            <div
                                            ...
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p2"
                                                    value="b,50">
                                                <label class="form-check-label">b. Ada, tercantum di dokumen RPJMD dan
                                                    RKPD
                                                </label>
                                            </div>
                                            <div
                                        ...
                                        <div class="fluid-container pt-4 pb-2">
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p3"
                                                    value="a,100">
                                                <label class="form-check-label">a. Ada dibuktikan dengan SK, Anggaran,
                                            ...
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p3"
                                                    value="b,75">
                                                <label class="form-check-label">b. Ada dibuktikan dengan SK, Anggaran,
                                            ...
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p3"
                                                    value="c,50">
                                                <label class="form-check-label">c. Ada dibuktikan dengan SK, Anggaran,
                                            ...
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p3"
                                                    value="d,25">
                                                <label class="form-check-label">d. Ada dibuktikan dengan SK, Anggaran,
                        ...
                        <form action="{{ route('tatananFour.update', $tatananFour->id) }}" method="POST"
                            ...
                            <div class="fv-row">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        4. Keberadaan rapat koordinasi (rakor) Tim Pembina UKS/M yang dilakukan secara
                                        rutin
                                        <div class="fluid-container pt-4 pb-2">
                                            <div
                                                class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            ...
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p4"
                                                    value="b,50">
                                                <label class="form-check-label">b. Ada dan dilakukan 2 - 3 kali dalam
                                                    setahun
                                                </label>
                                            </div>
                                            <div
                        ...
                        <div class="pb-3">
                            <!--begin::Title-->
                            <h5 class="fw-bold d-flex align-items-center text-dark">5.1 Satuan Pendidikan Ramah Anak
                            </h5>
                            <!--end::Title-->
                        </div>
                        <!--begin::Input group-->
                                        ...
                                        <div class="fluid-container pt-4 pb-2">
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p10"
                                                    value="a,100">
                                                <label class="form-check-label">a. Seluruh anak penyandang disabilitas
                                                    terlayani
                                                </label>
                                            </div>
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p10"
                                                    value="b,50">
                                                <label class="form-check-label">b. Sebagian anak penyandang disabilitas
                                                    terlayani
                                                </label>
                                            </div>
                                            <div
                        ...
                        <div class="pb-3">
                            <!--begin::Title-->
                            <h5 class="fw-bold d-flex align-items-center text-dark">8.1 Pendidikan Usia Dini/Paud Yang
                        ...
                        <form action="{{ route('tatananFour.update', $tatananFour->id) }}" method="POST"
                            ...
                            <div class="fv-row">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        13. Presentase sekolah pendidikan usia dini/PAUD yang menyelenggarakan promosi
                        ...
                        <div class="pb-3">
                            <!--begin::Title-->
                            <h5 class="fw-bold d-flex align-items-center text-dark">9.2 Sistem Informasi Terintegrasi
                            </h5>
                            <!--end::Title-->
                        </div>
                        <!--begin::Input group-->
                        <form action="{{ route('tatananFour.update', $tatananFour->id) }}" method="POST"
                            ...
                            <div class="fv-row">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        15. Keberadaan sekolah yang mengembangkan sistem informasi terintegrasi (contoh
                                        :
                                        data peserta didik, data kesehatan, data kondisi kesehatan lingkungan sekolah,
                                        dll.)
                                        <div class="fluid-container pt-4 pb-2">
                                            <div
                                                class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                        ...
                        <form action="{{ route('tatananFour.update', $tatananFour->id) }}" method="POST"
                            ...
                            <div class="fv-row">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        16. Adanya kegiatan kemitraan sekolah dengan pihak luar untuk mencapai sekolah
                                        sehat
                                        <div class="fluid-container pt-4 pb-2">
                                            <div
                                                class="form-check form-check-custom form-check-solid form-check-sm pb-4">
