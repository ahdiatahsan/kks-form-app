        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="mx-auto mw-1000px w-100 pt-5 pb-5"
                    action="{{ route('tatananFour.update', $tatananFour->id) }}" method="POST"
                    ...
                    <div class="w-100">
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    2. Keberadaan program UKS/M dalam perencanaan daerah (RPJMD, RKPD, Renstra PD dan
                                    Renja PD)
                                    <div class="fluid-container pt-4">
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p2"
                                                value="a,100">
                                            <label class="form-check-label">a. Ada, tercantum di dokumen RPJMD, RKPD,
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    5. Presentase Sekolah/Madrasah yang memiliki tim pelaksana UKS/M dibuktikan dengan
                                    SK
                                    <div class="fluid-container pt-4">
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    ...
                                    data peserta didik, data kesehatan, data kondisi kesehatan lingkungan sekolah, dll.)
                                    <div class="fluid-container pt-4">
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
