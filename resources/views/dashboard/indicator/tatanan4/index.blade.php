<x-dashboard.layout>
    ...
    <x-slot name="post">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <!--begin::Stepper-->
                <div class="stepper stepper-links d-flex flex-column" id="kt_stepper_tatanan4">
                    <!--begin::Nav-->
    ...
    <x-slot name="javascript">
        <script>
            // Stepper lement
            var element = document.querySelector("#kt_stepper_tatanan4");
