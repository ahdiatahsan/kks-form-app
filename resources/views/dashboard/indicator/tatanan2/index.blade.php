        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="mx-auto mw-1000px w-100 pt-5 pb-5"
                    action="{{ route('tatananTwo.update', $tatananTwo->id) }}" method="POST"
                    ...
                    <div class="w-100">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="fluid-container pt-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p23"
                                                value="b,75">
                                            <label class="form-check-label">b. Tercemar ringan 1.0 < IP ≤ 5.0 </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p23"
                                                value="c,50">
                                            <label class="form-check-label">c. Tercemar Sedang 5.0 < IP ≤ 10.0 </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p23"
                                                value="d,0">
                        ...
                        <div class="pb-3">
                            <!--begin::Title-->
                            <h5 class="fw-bold d-flex align-items-center text-dark">3.1 Upaya Pemenuhan Akses Air Minum
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="fluid-container pt-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p56"
                                                value="b,50">
                                            <label class="form-check-label">b. Ada di < 50% wilayah Kab/Kota </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p56"
                                                value="c,0">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="fluid-container pt-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p57"
                                                value="b,50">
                                            <label class="form-check-label">b. < 50% desa/kelurahan melakukan seluruh
                                                    program pengelolaan sampah </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p57"
                                                value="c,0">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="fluid-container pt-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p60"
                                                value="c,25">
                                            <label class="form-check-label">c. < 50% armada dalam kondisi layak pakai
                                                    </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p60"
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="fluid-container pt-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p88"
                                                value="d,25">
                                            <label class="form-check-label">d. < 25% rumah ibadat terdaftar </label>
                                        </div>
                                    </div>
                                    <div class="input-group input-group-sm pb-4">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="fluid-container pt-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p92"
                                                value="d,25">
                                            <label class="form-check-label">d. < 25% rumah ibadat yang memenuhi syarat
                                                    kesehatan </label>
                                        </div>
                                    </div>
                                    <div class="input-group input-group-sm pb-4">
