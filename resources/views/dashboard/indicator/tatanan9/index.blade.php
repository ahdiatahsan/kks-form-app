        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="mx-auto mw-1000px w-100 pt-5 pb-5"
                    action="{{ route('tatananNine.update', $tatananNine->id) }}" method="POST"
                    ...
                    <div class="w-100">
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    2. Upaya pencegahan dan penanggulangan bencana masuk ke dalam dokumen perencanaan
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    7. Melakukan kegiatan simulasi tanggap penanggulangan bencana minimal 1 kali dalam
                                    setahun.
                                    <div class="fluid-container pt-4">
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="fluid-container pt-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p10"
                                                value="b,50">
                                            <label class="form-check-label">b. 30-50% kategori desa/kelurahan pratama
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p10"
                                                value="c,25">
                                            <label class="form-check-label">c. Kurang dari 30% kategori desa/kelurahan
                                                pratama dari seluruh desa rawan bencana
                                            </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                    ...
                                    <div class="fluid-container pt-4">
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p11"
                                                value="a,100">
                                            <label class="form-check-label">a. Ada sistem peringatan dini terintegrasi
                                                dan berfungsi
                                            </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p11"
                                                value="b,50">
                                            <label class="form-check-label">b. Ada sistem peringatan dini terintegrasi
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="fluid-container pt-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p12"
                                                value="b,50">
                                            <label class="form-check-label">b. Ada rambu peringatan dini bencana, tapi
                                                jumlahnya terbatas
                                            </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    13. Pelaksanaan diseminasi informasi peringatan dini kepada stakeholder terkait dan
                                    masyarakat
                                    <div class="fluid-container pt-4">
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p13"
                                                value="c,0">
                                            <label class="form-check-label">c. Tidak ada kegiatan diseminasi informasi
                                    ...
                                    <div class="fluid-container pt-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            ...
                                            <label class="form-check-label">b. Ada peta rawan bencana tapi belum
                                                terdokumentasikan dengan baik dan belum tersosialisasikan secara rutin
                                            </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p14"
                                    ...
                                    <div class="fluid-container pt-4">
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p15"
                                                value="a,100">
                                            <label class="form-check-label">a. Ada perencanaan wilayah/tata ruang telah
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p15"
                                                value="b,0">
                                            <label class="form-check-label">b. Tidak ada perencanaan wilayah/tata ruang
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="fluid-container pt-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p16"
                                                value="b,50">
                                            <label class="form-check-label">b. Ada SKDR dan sistem pemantauannya tidak
                                                berfungsi
                                            </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="fluid-container pt-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p18"
                                                value="b,50">
                                            <label class="form-check-label">b. 30-50% Satuan Pendidikan Aman Bencana
                                                (SPAB)
                                            </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p18"
                                                value="c,25">
                                            <label class="form-check-label">c. Kurang dari 30% Satuan Pendidikan Aman
                                                Bencana (SPAB)
                                            </label>
                                        </div>
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    19. Adanya fasilitas sarana prasarana pendidikan yang aman dari resiko bencana di
                        ...
                        <div class="pb-3">
                            <!--begin::Title-->
                            <h5 class="fw-bold d-flex align-items-center text-dark">4.2 Pemberdayaan Masyarakat Tentang
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="fluid-container pt-4">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                                            <input class="form-check-input" type="radio" name="p20"
                                                value="b,50">
                                            <label class="form-check-label">b. Ada, tapi kegiatannya tidak aktif dan
                                                rutin
                                            </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid form-check-sm pb-4">
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    21. Melakukan kerjasama dengan pemerintah daerah lain yang berbatasan dengan kawasan
                        ...
                        <div class="fv-row">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    22. Adanya kerjasama desa/kelurahan rawan bencana dengan desa/kelurahan sekitarnya
