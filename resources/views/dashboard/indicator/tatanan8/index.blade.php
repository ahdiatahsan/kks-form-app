                    ...
                    <div class="w-100">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="fluid-container pt-4 pb-2">
                                            ...
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p5"
                                                    value="b,50">
                                                <label class="form-check-label">b. Ada dalam perencanaan daerah tapi
                                                    belum
                                                    terealisasi
                                                </label>
                                            </div>
                        ...
                        <form action="{{ route('tatananEight.update', $tatananEight->id) }}" method="POST"
                            ...
                            <div class="fv-row">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        9. Keberadaan penggiat penanganan pemerlu pelayanan kesejahteraan sosial (PPKS)
                                        baik
                        ...
                        <form action="{{ route('tatananEight.update', $tatananEight->id) }}" method="POST"
                            ...
                            <div class="fv-row">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        14. Adanya program pemenuhan kebutuhan kesehatan bagi komunitas adat terpencil
                                        dan
                                        daerah perbatasan
                                        <div class="fluid-container pt-4 pb-2">
                                            <div
                                        ...
                                        <div class="fluid-container pt-4 pb-2">
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p15"
                                                    value="a,100">
                                                <label class="form-check-label">a. Ada dan kegiatannya meningkat dari
                                                    tahun
                                                    sebelumnya
                                                </label>
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="fluid-container pt-4 pb-2">
                                            ...
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p17"
                                                    value="b,50">
                                                <label class="form-check-label">b. Dituangkan dalam Peraturan Kepala
                                                    Daerah
                                                </label>
                                            </div>
                                            <div
                                        ...
                                        <div class="fluid-container pt-4 pb-2">
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p21"
                                                    value="a,100">
                                                <label class="form-check-label">a. Ada upaya dan capaian angka sunat
                                                    pada
                                            ...
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p21"
                                                    value="b,50">
                                                <label class="form-check-label">b. Ada upaya dan capaian angka sunat
                                                    pada
                                            ...
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p21"
                                                    value="c,25">
                                                <label class="form-check-label">c. Ada upaya dan capaian angka sunat
                                                    pada
                        ...
                        <form action="{{ route('tatananEight.update', $tatananEight->id) }}" method="POST"
                            ...
                            <div class="fv-row">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        23. Adanya UPTD PA/P2TP2A (Pusat Pelayanan Terpadu Pemberdayaan Perempuan dan
                                        Anak)
                                        ...
                                        <div class="fluid-container pt-4 pb-2">
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p24"
                                                    value="a,100">
                                                <label class="form-check-label">a. Ada, semua kasus diproses secara
                                                    hukum
                                                </label>
                                            </div>
                                            <div
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="fluid-container pt-4 pb-2">
                                            ...
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p26"
                                                    value="c,0">
                                                <label class="form-check-label">c. Jumlahnya meningkat dibandingkan
                                                    tahun
                                                    sebelumnya
                                                </label>
                                            </div>
                                        ...
                                        <div class="fluid-container pt-4 pb-2">
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p31"
                                                    value="a,100">
                                                <label class="form-check-label">a. Ada pemberdayaan dan kegiatannya
                                                    rutin
                                                    dilakukan
                                                </label>
                                            </div>
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p31"
                                                    value="b,50">
                                                <label class="form-check-label">b. Ada pemberdayaan tapi kegiatannya
                                                    tidak
                                                    rutin dilakukan
                                                </label>
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="fluid-container pt-4 pb-2">
                                            ...
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="p32"
                                                    value="b,50">
                                                <label class="form-check-label">b. Tercantum dalam Peraturan Kepala
                                                    Daerah
                                                </label>
                                            </div>
                                            <div
