        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    @if (Auth::user()->hasAnyRole('administrator|district'))
                    <a href="{{ route('institutionalDistrict.create') }}" class="btn btn-sm btn-light-primary">
        ...
        <script>
            $(document).on('click', '.delete', function() {
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        var url = '{{ route("institutionalDistrict.destroy", ":institutionalDistrict") }}';
                        url = url.replace(':institutionalDistrict', id);
