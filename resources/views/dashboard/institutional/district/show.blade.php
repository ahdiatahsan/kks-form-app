        ...
        <x-dashboard.toolbar.main>
            ...
            <x-slot name="breadcrumb">
                <li class="breadcrumb-item">
                    <span class="text-muted">Daftar Pokja Desa Kelurahan Di {{ $districtName->name }}</span>
                </li>
            </x-slot>
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    ...
                    <span class="text-muted mt-1 fw-bold fs-7">Daftar Pokja Desa Kelurahan Di {{ $districtName->name }}</span>
                </h3>
        ...
        <script>
            $(document).ready(function() {
                $('#datatable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('institutionalDistrict.show', $institutionalDistrict->id) }}",
                    columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    }, {
