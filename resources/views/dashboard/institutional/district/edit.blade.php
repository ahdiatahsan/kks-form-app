<x-dashboard.layout>
    ...
    <x-slot name="title">Forkom Kecamatan</x-slot>
    {{-- End::Head component --}}
    ...
    <x-slot name="toolbar">
        <x-dashboard.toolbar.main>
            ...
            <x-slot name="backbutton">
                <!--begin::Button-->
                <a href="{{ route('institutionalDistrict.index') }}" class="btn btn-sm btn-light-success fw-bolder">
    ...
    <x-slot name="post">
        <!--begin::form-->
        <form class="form" action="{{ route('institutionalDistrict.update', $institutionalDistrict->id) }}" method="POST" autocomplete="off"
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder text-dark fs-5 my-1">Forkom Kecamatan</span>
                ...
                <div class="card-body">
                    <div class="mb-6">
                        ...
                        <div class="input-group">
                            <select class="form-select form-select-sm form-select-solid" name="period"
                                ...
                                <option value="{{ $institutionalDistrict->setting_id }}">
                                    {{ $institutionalDistrict->setting->period }}
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-6">
                        ...
                        <div class="input-group input-group-sm">
                            <input class="form-control" type="text" name="title"
                                value="{{ old('title', $institutionalDistrict->title ?? '') }}" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        @if ($institutionalDistrict->attachment_pdf != null)
                            <div class="input-group input-group-sm pb-2">
                                <a href="{{ asset('storage/institutionalDistrict/' . $institutionalDistrict->attachment_pdf) }}"
                    ...
                    <div class="mb-3">
                        ...
                        @if ($institutionalDistrict->attachment_img != null)
                            <div class="input-group input-group-sm pb-2">
                                <a href="{{ asset('storage/institutionalDistrict/' . $institutionalDistrict->attachment_img) }}"
    ...
    <x-slot name="javascript">
        ...
        <script>
            $('#select2Period').select2({
                ...
                ajax: {
                    url: '{{ route('district.select2-period') }}',
                    dataType: 'json',
                    delay: 250,
