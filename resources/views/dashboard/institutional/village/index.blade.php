        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    @if (Auth::user()->hasAnyRole('administrator|village'))
                    <a href="{{ route('institutionalVillage.create') }}" class="btn btn-sm btn-light-primary">
        ...
        <script>
            $(document).on('click', '.delete', function() {
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        var url = '{{ route("institutionalVillage.destroy", ":institutionalVillage") }}';
                        url = url.replace(':institutionalVillage', id);
