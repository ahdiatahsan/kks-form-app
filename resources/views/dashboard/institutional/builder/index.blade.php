        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('institutionalBuilder.create') }}" class="btn btn-sm btn-light-primary">
        ...
        <script>
            $(document).on('click', '.delete', function() {
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        var url = '{{ route("institutionalBuilder.destroy", ":institutionalBuilder") }}';
                        url = url.replace(':institutionalBuilder', id);
