<x-dashboard.layout>
    ...
    <x-slot name="toolbar">
        <x-dashboard.toolbar.main>
            ...
            <x-slot name="backbutton">
                <!--begin::Button-->
                <a href="{{ route('institutionalKks.index') }}" class="btn btn-sm btn-light-success fw-bolder">
    ...
    <x-slot name="post">
        <!--begin::form-->
        <form class="form" action="{{ route('institutionalKks.update', $institutionalKks->id) }}" method="POST" autocomplete="off"
                ...
                <div class="card-body">
                    <div class="mb-6">
                        ...
                        <div class="input-group">
                            <select class="form-select form-select-sm form-select-solid" name="period"
                                ...
                                <option value="{{ $institutionalKks->setting_id }}">
                                    {{ $institutionalKks->setting->period }}
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-6">
                        ...
                        <div class="input-group input-group-sm">
                            <input class="form-control" type="text" name="title"
                                value="{{ old('title', $institutionalKks->title ?? '') }}" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        @if ($institutionalKks->attachment_pdf != null)
                            <div class="input-group input-group-sm pb-2">
                                <a href="{{ asset('storage/institutionalKks/' . $institutionalKks->attachment_pdf) }}"
                    ...
                    <div class="mb-3">
                        ...
                        @if ($institutionalKks->attachment_img != null)
                            <div class="input-group input-group-sm pb-2">
                                <a href="{{ asset('storage/institutionalKks/' . $institutionalKks->attachment_img) }}"
